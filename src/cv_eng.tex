...
\descript{MSc in Product Development and Production Engineering}
\location{2024 - 2026}
GPA: 5.0 (33 ECTS)
...
\location{September 2023 - June 2024}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
  \item Developed \textbf{a web application} that enables the generation of configuration files for different \textbf{switches} and \textbf{routers}.
  \item \textbf{Teaching} new employees
\end{tightitemize}
...
\location{April 2022 - June 2024}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
  \item I was developing a device TrimSense, that makes possible exact sail curvature measurements and therefore it's possible to optimise the sail shape.
  \item Designed parts with \textbf{Solidworks} and then used \textbf{3D printing} to make the parts.
  \item Optimised \textbf{the production process} for the device.
  \item Changed design of the device to minimize production costs and increase durability of the device.
  \item Selected components and established \textbf{communication with companies} to fabricate the necessary parts.
\end{tightitemize}
...
\location{July 2022, November 2024 - March 2025}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
  ...
  \item \textbf{Optimize} designs to reduce weight, dimensions and production costs.
  \item Combine \textbf{mechanical} and \textbf{electrical} components to make the final product.
\end{tightitemize}
